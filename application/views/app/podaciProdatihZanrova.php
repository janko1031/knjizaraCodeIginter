...
{"label":"Kolicina prodatih","type":"number"}
],
"rows": [
<?php
//konekcija ka bazi
...
//priprema upita
$sql="SELECT COUNT(knjiga_id) as kolicina, nazivZanra FROM kupljene_knjige INNER JOIN knjige ON kupljene_knjige.knjiga_id = knjige.id_knjige INNER JOIN zanr ON knjige.zanr_id = zanr.zanr_id GROUP BY nazivZanra";
//izvršavanje upita
